...
try:
    variable_labels_path = Path(__file__).parent / "tm2py_utils" / "summary" / "validation" / "data_model" / "variable_labels.yaml"
...
try:
    ...
    validation_config_path = Path(__file__).parent / "tm2py_utils" / "summary" / "validation" / "validation_config.yaml"
...
def main():
    ...
    # Banner image
    banner_path = Path(__file__).parent / "tm2py_utils" / "summary" / "validation" / "outputs" / "dashboard" / "validation-app-banner.PNG"
    ...
    # Get validation directory (streamlit_app.py is at repo root)
    repo_root = Path(__file__).parent
    validation_dir = repo_root / "tm2py_utils" / "summary" / "validation"
