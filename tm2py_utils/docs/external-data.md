...
**Note:** This is for **pre-aggregated summary data from external sources**, not household travel survey microdata. Household travel surveys should be formatted to match the [CTRAMP data model](data-model.md) and processed as model inputs
